		...
		<el-dialog v-model="formVisible" :title="formTitle" width="80%" destroy-on-close :fullscreen='false'>
			<el-form class="formModel_form" ref="formRef" :model="form" label-width="$template2.back.add.form.base.labelWidth" :rules="rules">
				<el-row>
					...
					<el-col :span="12">
						<el-form-item label="支付密码" prop="zhifumima">
							<el-input class="list_inp" v-model="form.zhifumima" placeholder="支付密码"
								 type="text" 								:readonly="!isAdd||disabledForm.zhifumima?true:false" />
						</el-form-item>
					</el-col>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		if(formType == 'add'){
			...
			for(let x in row){
				...
				if(x=='zhifumima'){
					form.value.zhifumima = row[x];
					disabledForm.value.zhifumima = true;
					continue;
				}
				if(x=='jf'){
					form.value.jf = row[x];
